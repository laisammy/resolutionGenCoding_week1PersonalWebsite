import riceThumb from "./assets/06022026_thumbnail.png";
import knightThumb from "./assets/Screenshot 2026-02-26 203638.png";
    ...
    return (
        <div className = "flex-col items-baseline gap-3 bg-violet-300 p-4 rounded-lg">
            ...
            <div className="flex-col">
                ...
                <img src={riceThumb} className="max-w-2xl max-h-2xl m-5" alt="This This Rice Thumbnail"/>
                ...
                <img src={knightThumb} className="max-w-2xl max-h-2xl m-5" alt="Knight Platformer Game Thumbnail"/>
            </div>
        </div>
    );
}